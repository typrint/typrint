...
class Watcher
{
    public const string EVENT_TYPE_FILE_CREATED = 'fileCreated';
    public const string EVENT_TYPE_FILE_UPDATED = 'fileUpdated';
    public const string EVENT_TYPE_FILE_DELETED = 'fileDeleted';
    public const string EVENT_TYPE_DIRECTORY_CREATED = 'directoryCreated';
    public const string EVENT_TYPE_DIRECTORY_DELETED = 'directoryDeleted';
     ...
     * Start the watcher.
     *
     * @throws CouldNotStartWatcherException
     */
