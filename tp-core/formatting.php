...
{
    $safe_text = tp_check_invalid_utf8($text);
    $safe_text = _tp_specialchars($safe_text, ENT_COMPAT);
...
{
    $safe_text = tp_check_invalid_utf8($text);
    $safe_text = _tp_specialchars($safe_text, ENT_QUOTES);
    ...
    $safe_text = (string) preg_replace_callback(
        ...
        static function ($matches) {
            ...
            if (isset($matches['non_cdata'])) {
                ...
                return _tp_specialchars($matches['non_cdata'], ENT_XML1);
            }

            // Return the CDATA Section unchanged, escape HTML entities in the rest.
            return _tp_specialchars($matches['non_cdata_followed_by_cdata'], ENT_XML1).$matches['cdata'];
        },
        $safe_text
    );
...
function tp_html_excerpt(string $str, int $count, ?string $more = null): string
{
    ...
    $str = tp_strip_all_tags($str, true);
